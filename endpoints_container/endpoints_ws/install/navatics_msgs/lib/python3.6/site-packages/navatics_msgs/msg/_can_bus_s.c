...
bool navatics_msgs__msg__can_bus__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "navatics_msgs.msg._can_bus.CanBus",
        full_classname_dest, 33) == 0);
  }
  navatics_msgs__msg__CanBus * ros_message = _ros_message;
  {  // std_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "std_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->std_id = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // length
...
{
  /* NOTE(esteve): Call constructor of CanBus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("navatics_msgs.msg._can_bus");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CanBus");
  ...
  {  // std_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->std_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "std_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
